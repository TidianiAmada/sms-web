<template>
  <div class="container mx-auto p-6 bg-gray-50">
    <!-- Titre de la page -->
    <h2 class="text-4xl font-semibold text-gray-800 mb-6">Demandes de Transfert Sortante</h2>
      ...
      <table class="min-w-full table-auto">
        <thead class="bg-blue-100 text-gray-700">
          <tr>
            ...
            <th class="px-4 py-2 border-b">École de Destination</th>
            <th class="px-4 py-2 border-b"> Administrateur de l'École de Destination</th>
